    ...
    <footer id="contact" className="bg-black py-16 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 tracking-wider font-playfair">LA PORTE DES LAURENTIDES</h3>
            <p className="text-gray-300 text-sm leading-relaxed font-inter">
              Expérience gastronomique au cœur des Laurentides, où l'excellence culinaire rencontre la beauté naturelle.
            </p>
          </div>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 tracking-wider font-inter">CONTACT</h4>
            <div className="text-gray-300 text-sm space-y-2 font-inter">
              <p>123 Mountain View Road</p>
              <p>Saint-Sauveur, QC J0R 1R0</p>
              <p>Téléphone: (819) 555-0123</p>
              <p>Courriel: info@laportelaurentides.com</p>
            </div>
          </div>
          
          <div>
            <h4 className="text-lg font-semibold mb-4 tracking-wider font-inter">HEURES D'OUVERTURE</h4>
            <div className="text-gray-300 text-sm space-y-1 font-inter">
              <p>Dimanche - Mercredi: 11h00 - 21h00</p>
              <p>Jeudi - Samedi: 11h00 - 22h00</p>
            </div>
          </div>
        </div>
